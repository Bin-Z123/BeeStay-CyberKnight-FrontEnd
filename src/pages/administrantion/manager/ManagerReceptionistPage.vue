<template>
    <section>
        <div class="flex">
            <input type="text" class="mx-4 my-3 h-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-muesli-200 shadow-sm shadow-muesli-300 px-5 text-center" placeholder="Tìm kiếm">
        </div>
        <div class="px-4">
