<template>
  <section>
    <div class="flex flex-col xl:flex-row">
      <div class="w-1/2"></div>
      <div
        class="xl:w-1/2 flex items-center h-screen mx-3 justify-center xl:justify-start"
      >
          ...
          <form action="">
            ...
            <div class="flex mb-4">
              <div class="w-1/2 flex items-center">
                ...
                <label
                  for="remember"
                  class="ml-2 text-sm text-gray-500 select-none"
                  >Nhớ mật khẩu</label
                >
              </div>
            ...
            <div>
              <p class="text-center text-gray-500 mt-4">
                ...
                <RouterLink
                  to="/auth/login"
                  class="text-muesli-400 hover:underline"
