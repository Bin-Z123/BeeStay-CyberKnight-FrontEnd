        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2 flex items-center h-screen mx-3 justify-center md:justify-start">
                <div class="bg-white w-120 rounded-2xl p-10">
                    <h1 class="text-muesli-400 font-bold text-2xl flex justify-center">Đăng Nhập</h1>
                    <form action="">
                        <div>
                        ...
                        <div>
                            <button class="bg-muesli-400 hover:bg-white hover:text-muesli-400 border border-muesli-400 text-white font-bold py-2 px-4 w-full rounded duration-300">Đăng Nhập</button>
                        </div>
                        <div>
                            <p class="text-center text-gray-500 mt-4">Bạn chưa có tài khoản? <RouterLink to="/auth/register" class="text-muesli-400 hover:underline">Đăng ký</RouterLink></p>
                        </div>
                    </form>
                </div>
            </div>
