<template>
  ...
  <div class="relative z-10">
    ...
    >
      <form
        action=""
        class="bg-white lg:rounded-2xl rounded-b-2xl shadow-xl lg:-mt-14 text-[20px]"
      >
        <div
        ...
        >
          <div
            class="space-y-2 flex flex-col border-gray-200 sm:border-r-1 lg:w-4/14"
          >
          ...
          <div
            class="space-y-2 flex flex-col sm:border-r-1 border-gray-200 lg:w-4/14"
          >
          ...
          <div class="flex items-center justify-end border-gray-400 lg:w-2/14">
            <button
              class="w-full px-4 py-3 bg-muesli-400 text-white rounded-xl"
  ...
  <section class="relative w-full bg-white lg:p-[120px] p-[180px] px-4">
    <div
      class="lg:grid lg:grid-cols-2 gap-[30px] items-center lg:mt-0 md:mt-20 sm:mt-40 mt-80"
    >
      <!-- Image -->
        ...
        >
          ...
          >
            ...
            <div class="w-1/2 flex flex-col gap-1">
              ...
              <p class="text-gray-500 text-sm">Đội ngũ nhân viên</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="w-full md:mt-0 mt-10">
        <h2 class="text-3xl font-bold mb-4" data-aos="fade-up">Về Chúng Tôi</h2>
        <p class="text-lg mb-6" data-aos="fade-up" data-aos-delay="100">
          Chào mừng đến với Boking, nơi sang trọng gặp gỡ sự thoải mái tại trung
          tâm Canada. Kể từ năm 1999, chúng tôi đã tận tâm mang đến một trải
          nghiệm nghỉ ngơi tuyệt vời cho khách hàng của mình, kết hợp các tiện
          nghi hiện đại với vẻ đẹp vượt thời gian. Những căn phòng và suite được
          thiết kế đẹp mắt của chúng tôi cung cấp tầm nhìn tuyệt đẹp và tiện
          nghi sang trọng, đảm bảo một chốn nghỉ ngơi thật sự thoải mái cho dù
          bạn đến đây vì công việc hay giải trí.
        </p>
        <p class="text-lg" data-aos="fade-up" data-aos-delay="100">
          Nền tảng của chúng tôi kết nối bạn với nhiều loại bất động sản, đảm
          bảo rằng bạn sẽ tìm thấy nơi ở hoàn hảo cho chuyến đi tiếp theo của
          mình.
        </p>
      </div>
    </div>
  ...
  <section>
    <div
      class="flex flex-col justify-center items-center px-4 py-25 gap-3 w-full"
    >
      <h2 class="text-2xl text-muesli-400" data-aos="fade-up">Dịch Vụ</h2>
      <p class="text-4xl font-bold mb-10" data-aos="fade-up">
      ...
      >
        <div ref="facilitys" class="keen-slider rounded-2xl">
          <div
            class="keen-slider__slide sm:w-auto bg-white flex flex-col justify-center items-center rounded-2xl h-70 p-10 gap-3"
            v-for="facility in facilities.facilities"
            :key="facility.id"
          >
            <img
              :src="getImageUrl(facility.publicId)"
              class="w-14 h-14"
              alt=""
            />
  ...
  <section>
    <div class="bg-white px-4 py-25">
      <div class="container mx-auto">
        <div class="flex md:flex-row flex-col gap-8">
          ...
          <div class="md:w-1/2" data-aos="fade-left">
            <h1 class="text-gray-400">
              Các phòng của chúng tôi mang đến sự kết hợp hài hòa giữa sự thoải
              mái và vẻ sang trọng, được thiết kế để cung cấp một kỳ nghỉ đặc
              biệt cho mỗi khách. Mỗi phòng đều có giường nệm êm ái, ga trải
              giường chất lượng cao và một bộ gối để đảm bảo một giấc ngủ yên
              bình.
            </h1>
          </div>
        </div>
        <div
          ref="container"
          class="keen-slider mt-10 rounded-2xl"
          v-if="bookings.listRoomsAvailable.length"
        >
          <div
            class="keen-slider__slide h-[500px] flex items-center justify-center relative"
            v-for="room in bookings.listRoomsAvailable"
            :key="room.roomTypeId"
          >
            <img
              data-aos="flip-left"
              v-if="room.availableRoomDTO[0]?.roomImage[0]?.url"
              :src="getImageUrl(room.availableRoomDTO[0].roomImage[0].url)"
              alt="Ảnh Phòng"
              class="h-full w-full object-cover"
            />
            <div class="absolute inset-0 bg-black opacity-40"></div>
            <div
              class="absolute inset-0 flex flex-col justify-end text-white gap-3 p-4"
            >
              ...
              <div class="flex items-center gap-4">
                ...
                <span class="flex items-center gap-1">
                  <User class="inline-block w-5 h-5" />{{ room.peopleAbout }}
                  người
                </span>
              </div>
            ...
            <div class="md:w-4/5 md:p-10 flex flex-col gap-3">
              ...
              <div>
                <h1 class="text-gray-500">
                  ...
                  giường nệm êm ái, điều hòa hoạt động ổn định. Mọi vật dụng cần
                  thiết đều được chuẩn bị đầy đủ, từ tủ quần áo, bàn làm việc
  ...
  <section>
    <div
      class="bg-[url('@/assets/images/body.png')] bg-fixed bg-cover bg-center h-150 relative"
    >
...
const handleSearch = async () => {
  ...
  console.log(
    "Phòng Còn Trống Nè",
    JSON.stringify(bookings.listRoomsAvailable, null, 2)
  );
  router.push({
    path: "/user/roomtype",
    query: {
      checkins: checkin.value,
      checkouts: checkOutDate.value,
      numberOfPeoples: numberOfPeople.value,
    },
  });
};
