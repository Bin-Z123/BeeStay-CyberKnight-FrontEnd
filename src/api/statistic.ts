...
export const statistics = defineStore('statistic', () => {
    ...
    const getStatisticActive = async (): Promise<Statistic> => {
        try {
            const response = await axios.get<Statistic>(`${baseUrl}/admin/statistics/active-room-percentage`);
    ...
    const getStatisticCancel = async (): Promise<Statistic> => {
        try {
            const response = await axios.get<Statistic>(`${baseUrl}/admin/statistics/cancel-booking-percentage`);
    ...
    const getStatisticCheckin = async (): Promise<Statistic> => {
        try {
            const response = await axios.get<Statistic>(`${baseUrl}/admin/statistics/check-in-today-bookings`);
    ...
    const getStatisticCheckout = async (): Promise<Statistic> => {
        try {
            const response = await axios.get<Statistic>(`${baseUrl}/admin/statistics/check-out-today-bookings`);
    ...
    const getStatisticRoomActive = async (): Promise<Statistic> => {
        try {
            const response = await axios.get<Statistic>(`${baseUrl}/admin/statistics/count-active-rooms`);
    ...
    const getStatisticRoomInactive = async (): Promise<Statistic> => {
        try {
            const response = await axios.get<Statistic>(`${baseUrl}/admin/statistics/count-inactive-rooms`);
    ...
    const getChartData = async (year: string): Promise<ChartResponse> => {
        try {
            const response = await axios.get<ChartResponse>(`${baseUrl}/admin/statistics/revenue-by-year-and-month/${year}`);
