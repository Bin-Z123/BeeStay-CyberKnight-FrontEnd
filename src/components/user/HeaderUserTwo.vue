<template>
  <div class="">
    <div
      class="container mx-auto flex justify-center items-center text-gray-500"
    >
      <div class="w-5/12 lg:flex hidden items-center gap-5">
        <div class="relative group">
          <div
            class="flex items-center gap-1 text-base font-semibold cursor-pointer group-hover:text-muesli-500"
          >
            Trang Chủ
        ...
        <div>
          <RouterLink
            ...
            v-if="hasPermission"
            class="text-base font-semibold hover:text-muesli-500"
            >Quản lý</RouterLink
          >
        </div>
        <div class="relative group">
      ...
      <div class="md:w-2/12 w-2/3 md:flex justify-center py-1">
        <RouterLink to="/user/home"
          ><img src="../../assets/images/BeeStay.png" alt="" class="w-40"
        /></RouterLink>
      </div>
...
const hasPermission = computed(() => {
  return ["ADMIN", "MANAGER", "RECEPTIONIST"].includes(
    authStore.user?.role?.roleName || ""
  );
});
